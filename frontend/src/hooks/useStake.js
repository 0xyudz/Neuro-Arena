...
export function useStake(userWallet) {
    const [loading, setLoading] = useState(false);
    const stake = useCallback(async (agentId, amount) => {
        if (!userWallet) {
    ...
    const getAgentStakes = useCallback(async (agentId) => {
        try {
...
//# sourceMappingURL=useStake.js.map