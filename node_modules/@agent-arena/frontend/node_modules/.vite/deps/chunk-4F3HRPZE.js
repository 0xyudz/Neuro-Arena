...
import {
  require_elliptic
} from "./chunk-CWRQ3FAX.js";
import {
  HashMD as HashMD2
} from "./chunk-KRUJKUVE.js";
import {
  LruMap,
  defineFormatter,
  hexToNumber,
...
import {
  ...
  init_sha2,
  sha256
} from "./chunk-O67TDPLV.js";
import {
  init_sha3,
  keccak_256
} from "./chunk-7TUG6N5B.js";
import {
  anumber,
  clean,
  concatBytes,
...
var PositionOutOfBoundsError3 = class extends BaseError4 {
...
function getContractError2(err, { abi, address, args, docsPath: docsPath2, functionName, sender }) {
...
async function recoverPublicKey2({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k14 } = await import("./secp256k1-5K4KAG3D.js");
  const signature_ = (() => {
...
var EstimateGasExecutionError2 = class extends BaseError {
  constructor(cause, { account, docsPath: docsPath2, chain, data, gas, gasPrice, maxFeePerGas, maxPriorityFeePerGas, nonce, to: to3, value }) {
    var _a;
...
function getEstimateGasError2(err, { docsPath: docsPath2, ...args }) {
  const cause = (() => {
...
function getTransactionError2(err, { docsPath: docsPath2, ...args }) {
  const cause = (() => {
    const cause2 = getNodeError(err, args);
    if (cause2 instanceof UnknownNodeError)
      return err;
...
async function prepareTransactionRequest2(client, args) {
  ...
  const fillResult = attemptFill ? await getAction2(client, fillTransaction, "fillTransaction")({ ...request, nonce }).then((result) => {
    ...
    if (error.name !== "TransactionExecutionError")
      return request;
    const executionReverted = (_a2 = error.walk) == null ? void 0 : _a2.call(error, (e4) => {
      const error2 = e4;
      return error2.name === "ExecutionRevertedError";
    });
    if (executionReverted)
      throw e3;
    const unsupported = (_b2 = error.walk) == null ? void 0 : _b2.call(error, (e4) => {
      var _a3;
      const error2 = e4;
...
function decodeEventLog2(parameters) {
  ...
  const isUnnamed = inputs == null ? void 0 : inputs.some((x6) => !("name" in x6 && x6.name));
  const args = isUnnamed ? [] : {};
  const indexedInputs = inputs.map((x6, i5) => [x6, i5]).filter(([x6]) => "indexed" in x6 && x6.indexed);
...
function parseEventLogs2(parameters) {
  ...
  return logs.map((log) => {
    var _a;
    const formattedLog = typeof log.blockNumber === "string" ? formatLog2(log) : log;
    ...
    if (!event && !strict) {
      ...
      try {
        ...
        const isUnnamed = (_a = abiItem.abi.inputs) == null ? void 0 : _a.some((x6) => !("name" in x6 && x6.name));
        return {
          ...formattedLog,
          args: isUnnamed ? [] : {},
  ...
  switch (abiParameterType) {
    ...
    default: {
      ...
      if (/[a-z]+[1-9]{0,3}(\[[0-9]{0,}\])+$/.test(abiParameterType)) {
        return Array.isArray(arg) && arg.every((x6) => isArgOfType2(x6, {
          ...abiParameter,
...
function fromAbi2(abi, name2, options) {
  ...
  if (abiItems.length === 0)
    throw new NotFoundError2({ name: name2 });
...
function getSelector2(...parameters) {
  const abiItem = (() => {
    if (Array.isArray(parameters[0])) {
      const [abi, name2] = parameters;
      return fromAbi2(abi, name2);
    }
    return parameters[0];
  })();
...
function getSignatureHash(...parameters) {
  ...
  if (typeof abiItem !== "string" && "hash" in abiItem && abiItem.hash)
    return abiItem.hash;
  return keccak2564(fromString2(getSignature(abiItem)));
}
  ...
  constructor(x6, y5) {
    super("Found ambiguous types in overloaded ABI Items.", {
      metaMessages: [
        ...
        `\`${x6.type}\` in \`${normalizeSignature2(formatAbiItem(x6.abiItem))}\`, and`,
        `\`${y5.type}\` in \`${normalizeSignature2(formatAbiItem(y5.abiItem))}\``,
        "",
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-4F3HRPZE.js.map
