...
var ICONS = {
  add: async () => (await import("./add-V7AU2WIY.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-GLSLBQB3.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-EOJDJP3I.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-ZZZ7ZBMY.js")).appStoreSvg,
  apple: async () => (await import("./apple-6LYLDSCU.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-WSG25YAX.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-BSBSN4NF.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-NCQR5TVY.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-K2QLOYKX.js")).arrowTopSvg,
  bank: async () => (await import("./bank-EXB6VG2L.js")).bankSvg,
  browser: async () => (await import("./browser-RZEKEC2C.js")).browserSvg,
  card: async () => (await import("./card-WXOBWMZV.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-FR5RKY7X.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-U57SGPH6.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-F6NCVOSW.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-GF3TQC2X.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-ZNPEFVIP.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-3IRDKL4W.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-RDGNFAGC.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-5VPRIE26.js")).clockSvg,
  close: async () => (await import("./close-NZQ4BNAA.js")).closeSvg,
  compass: async () => (await import("./compass-5EHFP7O2.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-626HYWVS.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-MGKUVJVX.js")).copySvg,
  cursor: async () => (await import("./cursor-MRDJUQWV.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-HBOZA5KW.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-4YKYBPMQ.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-3O64V4DP.js")).disconnectSvg,
  discord: async () => (await import("./discord-YQBB22QX.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-MXN5SVI5.js")).etherscanSvg,
  extension: async () => (await import("./extension-U5S3E6OY.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-7GCLQJRC.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-T64WPLT4.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-R2CUF73H.js")).farcasterSvg,
  filters: async () => (await import("./filters-TDIYXRAZ.js")).filtersSvg,
  github: async () => (await import("./github-YL3KQIIV.js")).githubSvg,
  google: async () => (await import("./google-WJ2TO63X.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-YOGBXIDC.js")).helpCircleSvg,
  image: async () => (await import("./image-2D2AILNN.js")).imageSvg,
  id: async () => (await import("./id-VO5ZCKU5.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-KCWR37WE.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-SBEQDPUK.js")).lightbulbSvg,
  mail: async () => (await import("./mail-HA3F5MER.js")).mailSvg,
  mobile: async () => (await import("./mobile-PATHOKPK.js")).mobileSvg,
  more: async () => (await import("./more-WIEFNZEG.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-P3QOBYPJ.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-MHG26MRB.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-TLRZ6COX.js")).offSvg,
  playStore: async () => (await import("./play-store-SNWIQ45N.js")).playStoreSvg,
  plus: async () => (await import("./plus-VRH7RDID.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-CNT5JALM.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-W6NYN4OY.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-57CZDZYO.js")).refreshSvg,
  search: async () => (await import("./search-SNHRXZ4X.js")).searchSvg,
  send: async () => (await import("./send-4ESS2NOU.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-Z2OC2ATI.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-RWB2EWCP.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-DICGIWHI.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-TZIVZE7Z.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-GPMFXTIT.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-2HT6R6Q3.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-2ROCRGXP.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-6QWJOUYF.js")).twitchSvg,
  twitter: async () => (await import("./x-FZAPR7O7.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-U6NWP43D.js")).twitterIconSvg,
  verify: async () => (await import("./verify-K4QQ2QTR.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-PSAYFE46.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-RGGKSIFM.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-ILNVXRAU.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-ILNVXRAU.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-ILNVXRAU.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-5PDN4CXJ.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-TCFW4FUM.js")).warningCircleSvg,
  x: async () => (await import("./x-FZAPR7O7.js")).xSvg,
  info: async () => (await import("./info-Z5R57RQU.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-2YOJJQLI.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-I73CPBHG.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CNJXZCDO.js.map
