...
INSERT INTO "new_Agent" ("agentWallet", "createdAt", "description", "holders", "id", "imageUrl", "isChampion", "lastAction", "marketCap", "name", "ownerWallet", "personality", "price", "priceChange", "score", "strategy", "tokenMint", "tokenSymbol", "trades", "updatedAt", "volume24h") SELECT "agentWallet", "createdAt", "description", "holders", "id", "imageUrl", "isChampion", "lastAction", "marketCap", "name", "ownerWallet", "personality", "price", "priceChange", "score", "strategy", "tokenMint", "tokenSymbol", "trades", "updatedAt", "volume24h" FROM "Agent";
DROP TABLE "Agent";
