...
export const STRATEGIES: readonly StrategyType[] = [
  'momentum', 
  'contrarian', 
  'random', 
  'adaptive',
...
export const ACTION_WEIGHTS: Record<PersonalityType, Record<ActionType, number>> = {
...
export const ACTION_SCORE_MODIFIERS: Record<ActionResult, Record<ActionType, number>> = {
