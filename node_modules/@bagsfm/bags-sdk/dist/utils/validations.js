...
exports.validateAndNormalizeCreateDexscreenerOrderParams = validateAndNormalizeCreateDexscreenerOrderParams;
exports.validateAndNormalizeStartPaymentParams = validateAndNormalizeStartPaymentParams;
exports.validateAndNormalizeIncorporateParams = validateAndNormalizeIncorporateParams;
...
function validateAndNormalizeCreateFeeShareConfigParams(params, tipConfig) {
    ...
    if (params.bagsConfigType && !Object.values(types_1.BAGS_CONFIG_TYPE).includes(params.bagsConfigType)) {
    ...
    return {
        ...
        bagsConfigType: params.bagsConfigType ?? types_1.BAGS_CONFIG_TYPE.DEFAULT,
    };
}
...
function validateAndNormalizeCreateDexscreenerOrderParams(params) {
    if (!params.description || typeof params.description !== 'string' || params.description.length < 1) {
        throw new Error('Description must be at least 1 character');
    }
    if (params.description.length > 1000) {
...
function validateAndNormalizeStartPaymentParams(params) {
...
function validateAndNormalizeIncorporateParams(params) {
    ...
    if (params.category !== undefined && !types_1.INCORPORATION_CATEGORIES.includes(params.category)) {
        throw new Error(`Category must be one of: ${types_1.INCORPORATION_CATEGORIES.join(', ')}`);
    }
